...
class UploadViewController: UIViewController {
    ...
    @IBOutlet weak var DBMImageView: UIImageView!
...
//        drawArea.backgroundColor = areaColor
    ...
    func showAlert() {
        ...
        CameraHandler.shared.imagePickedBlock = { (image) in
                ...
                self.DBMImageView.image = self.resizeImage(image: image, newWidth: self.DBMImageView.frame.width, newHeight: self.DBMImageView.frame.height)
