...
class CustomizationTripleViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.colorPickerView.constant = self.view.frame.height/6
        draw()
    ...
    @IBAction func selectTripleTopColor(_ sender: UIButton) {
        sender.tag = 1
        makeColorSelector(sender)
    }
    
    @IBAction func selectTripleMiddleColor(_ sender: UIButton) {
        sender.tag = 2
        makeColorSelector(sender)
    }
    
    @IBAction func selectTripleBottomColor(_ sender: UIButton) {
        sender.tag = 3
        makeColorSelector(sender)
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if let nextController = segue.destination as? UploadTripleViewController{
//            nextController.layersGroup = self.drawArea.layer.sublayers
            ...
            nextController.colorBot = self.colorBot
...
extension CustomizationTripleViewController: UITextFieldDelegate{
    func textFieldDidChangeSelection(_ textField: UITextField) {
        if textField == self.colorTripleTop{
                    ...
                    if str.first != "#" {
                        ...
                        if str.count == 6 || str.count == 3{
                            if let color: UIColor = UIColor(hexString: str) {
                                ...
                                //draw()
                                self.colorTripleTop.textColor = color
                                self.TTMView.backgroundColor = color
                                self.lblTTMTWidth.textColor = self.updateContrastColor(selectedColor: color)
                                self.lblTTMBWidth.textColor = self.updateContrastColor(selectedColor: color)
                                self.lblTTMLHeight.textColor = self.updateContrastColor(selectedColor: color)
                                self.lblTTMRHeight.textColor = self.updateContrastColor(selectedColor: color)
            ...
            else if textField == self.colorTripleMiddle{
                if var str = textField.text{
                    if str.isEmpty {
                        textField.text = "#"
                    ...
                    if str.first != "#" {
                        ...
                        if str.count == 6 || str.count == 3{
                            if let color: UIColor = UIColor(hexString: str) {
                                ...
                                //draw()
                                self.colorTripleMiddle.textColor = color
                                self.TMMView.backgroundColor = color
                                self.lblTMMTWidth.textColor = self.updateContrastColor(selectedColor: color)
                                self.lblTMMBWidth.textColor = self.updateContrastColor(selectedColor: color)
                                self.lblTMMLHeight.textColor = self.updateContrastColor(selectedColor: color)
                                self.lblTMMRHeight.textColor = self.updateContrastColor(selectedColor: color)
            ...
            else if textField == self.colorTripleBottom{
                if var str = textField.text{
                                    if str.isEmpty {
                        textField.text = "#"
                    ...
                    if str.first != "#" {
                        ...
                        if str.count == 6 || str.count == 3{
                            if let color: UIColor = UIColor(hexString: str) {
                                ...
                                //draw()
                                self.colorTripleBottom.textColor = color
                                self.TBMView.backgroundColor = color
                                self.lblTBMTWidth.textColor = self.updateContrastColor(selectedColor: color)
                                self.lblTBMBWidth.textColor = self.updateContrastColor(selectedColor: color)
                                self.lblTBMLHeight.textColor = self.updateContrastColor(selectedColor: color)
                                self.lblTBMRHeight.textColor = self.updateContrastColor(selectedColor: color)
...
extension CustomizationTripleViewController: ChromaColorPickerDelegate{
    func colorPickerDidChooseColor(_ colorPicker: ChromaColorPicker, color: UIColor) {
        ...
        UIView.animate(withDuration: 0.2,
            ...
            UIView.animate(withDuration: 0.2, animations: {
                ...
                case 1:
                    self.colorTripleTop.textColor = color
                    self.colorTripleTop.text = "#" + color.hexCode
                ...
                case 2:
                    self.colorTripleMiddle.textColor = color
                    self.colorTripleMiddle.text = "#" + color.hexCode
                ...
                case 3:
                    self.colorTripleBottom.textColor = color
                    self.colorTripleBottom.text = "#" + color.hexCode
                    self.colorBot = UIColor(hexString: color.hexCode)
                    self.TBMView.backgroundColor = color
                    self.lblTBMTWidth.textColor = self.updateContrastColor(selectedColor: color)
                    self.lblTBMBWidth.textColor = self.updateContrastColor(selectedColor: color)
                    self.lblTBMLHeight.textColor = self.updateContrastColor(selectedColor: color)
...
extension CustomizationTripleViewController{
